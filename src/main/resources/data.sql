...
/* reviewsテーブル */
INSERT IGNORE INTO reviews (id, house_id, user_id, score, comment) VALUES (1, 1, 1, 3, '部屋が綺麗で、快適に過ごせました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, score, comment) VALUES (2, 1, 2, 4, 'スタッフが親切で、気持ちよく滞在できました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, score, comment) VALUES (3, 1, 3, 5, '周辺の飲食店が充実していて、楽しめました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, score, comment) VALUES (4, 1, 4, 4, '静かな環境でゆっくり休めました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, score, comment) VALUES (5, 1, 5, 3, 'Wi-Fiが快適で助かりました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, score, comment) VALUES (6, 1, 6, 4, 'アクセスが良く、観光に最適でした。');
INSERT IGNORE INTO reviews (id, house_id, user_id, score, comment) VALUES (7, 1, 7, 4, '駅から近く、便利でした。');
INSERT IGNORE INTO reviews (id, house_id, user_id, score, comment) VALUES (8, 1, 8, 5, '宿泊費が手頃で、コストパフォーマンスが良かったです。');
INSERT IGNORE INTO reviews (id, house_id, user_id, score, comment) VALUES (9, 1, 9, 4, '施設内の設備が充実していました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, score, comment) VALUES (10, 1, 10, 5, '清潔感があり、気持ちよく滞在できました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, score, comment) VALUES (11, 1, 11, 3, '食事が美味しく、お風呂が気持ちよかったです。');
